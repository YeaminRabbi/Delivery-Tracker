                        ...
                        <div class="col-md-12 col-lg-12 col-xl-3">
                            ...
                            <div class="card m-b-30">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item" style="text-align: center;"><span style="font-weight: 700;color: green;font-size: 20px;">BKash:</span> <?= $user['bkash']; ?></li>
                                    <li class="list-group-item" style="text-align: center;"><span style="font-weight: 700;color: green;font-size: 20px;">Nagad:</span> <?= $user['nagad']; ?></li>
                                    <li class="list-group-item" style="text-align: center;"><span style="font-weight: 700;color: green;font-size: 20px;">Rocket:</span> <?= $user['rocket']; ?></li>
                                    <li class="list-group-item" style="text-align: center;font-weight: 700;color: green"><span style="font-weight: 700;color: red">Payment Requested by:</span>
                                        <?php 
                                            
                                            echo $order['payment_request'];            
                                        ?>
