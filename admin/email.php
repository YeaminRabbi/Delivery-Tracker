                        ...
                        <div class="col-12">
                            ...
                            <div class="email-leftbar card">
                                <div class="mail-list m-t-20">
                                    <a href="#" class="active">Inbox
                                     <span class="ml-1"><?= $total_email ?></span></a>
                                     <a href="email_accepted.php">Complain Accepted</a>
                                </div>
                            </div>
                            <!-- End Left sidebar -->
                                ...
                                <div class="card">
                                    ...
                                    <ul class="message-list">
                                                ...
                                                <?php
                                                    ...
                                                    $sql="select * from contactform as r where r.email_status=0;"; 
